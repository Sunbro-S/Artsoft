using System.Text;
using ExampleCore.ZookeperSemafor.Interfaces;
using org.apache.zookeeper;

namespace ExampleCore.ZookeperSemafor;

public class DistributedSemafor: IDistrebutedSemafor
{
    ...
    public DistributedSemafor(ZooKeeper zooKeeper, string semaphorePath, int maxCount)
    {
